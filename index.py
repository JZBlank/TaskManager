...
def pop_up_window(event):
    ...
    # NEW TASK BUTTONS
    addNewTaskButton = tk.Button(pop_up, text="Add Task", fg="white", bg="#0066FF", activebackground="blue", activeforeground="white")
    addNewTaskButton.pack()
    addNewTaskButton.place(x=485, y=350)  
